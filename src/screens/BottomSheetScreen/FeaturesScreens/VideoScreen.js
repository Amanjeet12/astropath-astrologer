...
import {fetchVideoStats} from '../../../redux/features/StatsSlice';
...
const VideoScreen = () => {
  ...
  const fetchData = async () => {
    const [firstData] = await Promise.all([
      dispatch(fetchVideoStats(islogin.jwt_token)),
    ]);
      ...
      <ImageBackground
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.mainContainer}>
            ...
            <View>
              <BackButton placeholder={'Video Call'} />
            </View>
            {callstats ? (
              <>
                <View style={styles.boxContainer}>
                  <View style={styles.flexBox}>
                    <Text style={styles.title}>VC Stats</Text>
                    <Image
                      source={images.stat}
                ...
                <View style={{marginTop: 20}}>
                  <Text style={styles.title}>VC History</Text>
